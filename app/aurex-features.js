...
// ─── CREAR LISTA ───
// FIX #4: wlCreateListModal acepta editList → modo edición (renombrar + color), paridad nativa WatchlistScreen
...
window.wlCreateList = function(){
  ...
  // FIX #4: si estamos editando, actualizar (nombre + color + principal) en vez de crear
  if(window._wlEditId){
